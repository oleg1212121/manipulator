...
elements = {
    "coordinates": {
        'browser_focus': [300, 300],
        'email_input': [900, 405],
        'password_input': [900, 500],
        'login_submit': [950, 640],
        'login_checkbox': [770, 570],
        "browser": [560, 1060],
        # "resize": [1005,305],
        "mailbox": [850, 640],
        "email": [400, 220],
        ...
        "approval_submit": [950, 580],
        "approval_input": [950, 430],
        "approval_checkbox": [770, 513],
        "appointment_button": [1270, 235],
        "refresh_button": [92, 62]
    },
    "animation": {
        "fast_duration": 0.2,
        "pre_middle_duration": 0.5,
        "middle_duration": 1.2,
        "slow_duration": 3,
        "short_sleep": 5,
        "middle_sleep": 10,
